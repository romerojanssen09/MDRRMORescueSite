...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MDRRMO Admin Panel'); ?></title>
...
<body class="bg-primary-900">
        ...
        <aside class="w-64 bg-primary-950 flex flex-col border-r border-primary-800">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                ...
                <div class="mb-4">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-secondary-400 text-primary-950 font-medium' : 'text-primary-300 hover:bg-primary-800 hover:text-primary-100'); ?>">
                ...
                <div class="mb-4">
                    ...
                    <a href="<?php echo e(route('admin.reports.index')); ?>" class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all <?php echo e(request()->routeIs('admin.reports.*') ? 'bg-secondary-400 text-primary-950 font-medium' : 'text-primary-300 hover:bg-primary-800 hover:text-primary-100'); ?>">
                        <i class="fas fa-exclamation-circle w-5 text-base"></i>
                        <span class="ml-3">Reports</span>
                        <?php if(isset($pendingCount) && $pendingCount > 0): ?>
                            <span class="ml-auto bg-accent-400 text-white text-xs font-bold px-2 py-0.5 rounded-full"><?php echo e($pendingCount); ?></span>
                        <?php endif; ?>
                    </a>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <a href="<?php echo e(route('admin.teams.index')); ?>" class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all <?php echo e(request()->routeIs('admin.teams.*') ? 'bg-secondary-400 text-primary-950 font-medium' : 'text-primary-300 hover:bg-primary-800 hover:text-primary-100'); ?>">
                        <i class="fas fa-users-gear w-5 text-base"></i>
                        <span class="ml-3">Rescue Teams</span>
                    </a>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all <?php echo e(request()->routeIs('admin.users.*') ? 'bg-secondary-400 text-primary-950 font-medium' : 'text-primary-300 hover:bg-primary-800 hover:text-primary-100'); ?>">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3 flex-1 min-w-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-primary-100 truncate"><?php echo e(session('user_name', 'Admin')); ?></p>
                            <p class="text-xs text-primary-500">Administrator</p>
                        </div>
                    </div>
                    <form method="POST" action="<?php echo e(route('admin.logout')); ?>" id="logoutForm" class="inline">
                        <?php echo csrf_field(); ?>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-primary-800 shadow-lg border-b border-primary-700">
                <div class="flex items-center justify-between px-6 py-4">
                    <div>
                        <h2 class="text-lg font-semibold text-primary-100"><?php echo $__env->yieldContent('header', 'Dashboard'); ?></h2>
                        <p class="text-xs text-primary-400 mt-0.5"><?php echo $__env->yieldContent('subtitle', 'Overview and statistics'); ?></p>
                    </div>
    ...
    <script>
        ...
        function initializeSupabase() {
            ...
            const supabaseUrl = '<?php echo e(config('services.supabase.url')); ?>';
            const supabaseKey = '<?php echo e(config('services.supabase.anon_key')); ?>';
...
<?php /**PATH D:\New folder (4)\MDRRMORescueApp\MDRRMOSite\resources\views\layouts\admin.blade.php ENDPATH**/ ?>