<?php $__env->startSection('title', 'Assign Team - Map View'); ?>
<?php $__env->startSection('header', 'Assign Team to Emergency Report'); ?>
        ...
        <div class="card border border-primary-700 p-5 sticky top-6">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div>
                    ...
                    <p class="text-sm text-primary-200"><?php echo e($report->location); ?></p>
                </div>
                
                <?php if($report->citizen): ?>
                <div>
                    <span class="text-xs text-primary-400 block mb-1">Citizen:</span>
                    <p class="text-sm text-primary-200"><?php echo e($report->citizen->full_name); ?></p>
                    <p class="text-xs text-primary-500"><?php echo e($report->citizen->phone); ?></p>
                </div>
                <?php endif; ?>
            ...
            <div class="mt-6 pt-6 border-t border-primary-700">
                ...
                <div class="space-y-2 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                    <?php $__empty_1 = true; $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div id="team-card-<?php echo e($team->id); ?>" 
                             class="p-3 border border-primary-700 rounded-lg hover:bg-primary-700 cursor-pointer transition-all <?php echo e($team->status === 'On Mission' ? 'opacity-60' : ''); ?>"
                             onclick="selectTeamFromList('<?php echo e($team->id); ?>', <?php echo e($team->latitude); ?>, <?php echo e($team->longitude); ?>)">
                            <div class="flex justify-between items-start gap-3">
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-sm text-primary-100 truncate"><?php echo e($team->team_name); ?></p>
                                    <p class="text-xs text-primary-400"><?php echo e($team->specialization); ?></p>
                                    <p class="text-xs text-primary-500 mt-1"><?php echo e($team->members_count); ?> members</p>
                                    <?php if($team->status === 'On Mission'): ?>
                                ...
                                <div class="text-right flex flex-col items-end gap-2 flex-shrink-0">
                                    <span class="px-2 py-1 bg-secondary-900 text-secondary-300 text-xs rounded font-semibold">
                                        <?php echo e($team->distance); ?> km
                                    </span>
                                    <?php if($report->assigned_team_id): ?>
                                        <?php if($report->assigned_team_id == $team->id): ?>
                                            <button disabled
                                    ...
                                    <?php else: ?>
                                        <button onclick="event.stopPropagation(); showConfirmModal('<?php echo e($team->id); ?>', '<?php echo e($team->team_name); ?>', <?php echo e($team->members_count); ?>, '<?php echo e($team->specialization); ?>', <?php echo e($team->distance); ?>)" 
...
<div id="confirmModal" class="fixed inset-0 bg-black/80 backdrop-blur-sm hidden items-center justify-center z-50">
    <div class="card border border-primary-700 p-6 max-w-md w-full mx-4">
        ...
        <form id="assignForm" action="<?php echo e(route('admin.reports.update', $report)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
const teams = <?php echo json_encode($teams, 15, 512) ?>;
const reportLat = <?php echo e($report->latitude ?? 10.465); ?>;
const reportLng = <?php echo e($report->longitude ?? 122.826); ?>;
const assignedTeamId = '<?php echo e($report->assigned_team_id); ?>';
...
new mapboxgl.Marker({ color: '#3B82F6' })
    ...
    .setPopup(new mapboxgl.Popup().setHTML(`
        <div class="p-2">
            ...
            <p class="text-sm"><?php echo e($report->emergency_type); ?></p>
        </div>
    `))
    .addTo(map);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder (4)\MDRRMORescueApp\MDRRMOSite\resources\views\admin\reports\assign-map.blade.php ENDPATH**/ ?>