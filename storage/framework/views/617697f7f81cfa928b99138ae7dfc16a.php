<?php $__env->startSection('title', 'Create Rescuer'); ?>
<?php $__env->startSection('header', 'Create New Rescuer'); ?>
<?php $__env->startSection('subtitle', 'Add a new rescuer to the system'); ?>
...
<div class="max-w-3xl mx-auto">
    ...
    <form id="createUserForm" action="<?php echo e(route('admin.users.store')); ?>" method="POST" novalidate>
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           name="full_name" 
                           id="full_name"
                           value="<?php echo e(session('clear_form') ? '' : old('full_name')); ?>" 
                           class="input-field text-sm <?php $__errorArgs = ['full_name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="email" 
                           name="email" 
                           id="email"
                           value="<?php echo e(session('clear_form') ? '' : old('email')); ?>" 
                           class="input-field text-sm <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-accent-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="tel" 
                           name="phone" 
                           id="phone"
                           value="<?php echo e(session('clear_form') ? '' : old('phone')); ?>" 
                           class="input-field text-sm <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-accent-400 <?php unset($message);
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="password" 
                           name="password" 
                           id="password"
                           class="input-field text-sm <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-accent-400 <?php unset($message);
...
<script>
    ...
    const shouldClearForm = <?php echo e(session('clear_form') ? 'true' : 'false'); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder (4)\MDRRMORescueApp\MDRRMOSite\resources\views\admin\users\create.blade.php ENDPATH**/ ?>